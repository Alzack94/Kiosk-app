...
public class TestBaggage 
{
	...
	public void testGetBagVolume() 
	{
		...
		Baggage bag1 = new Baggage("BG101",50.0,40.0,20.0,25);
		...
		Baggage bag2 = new Baggage("BG102",35.0,25.0,15.0,15.0);
	...
	{
		Baggage bag3 = new Baggage("BG103",-35.0,25.0,15.0,15.0);
	...
	public  void invalidBagWeightSupplied() 
	{
		try 
		{
			Baggage bag4 = new Baggage("BG104",30.0,20.0,10.0,-20.0);
